...
locals {
  ...
  loki_svc    = var.loki_mode == "distributed" ? "loki-loki-distributed-gateway.${var.k8s_namespace}.svc.cluster.local" : "loki-loki.${var.k8s_namespace}.svc.cluster.local:3100"
